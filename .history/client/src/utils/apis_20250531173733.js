const apis = () => {
    ...
    const list = {
        ...
        // receiverRegister: `${local}user/registration/receiver`,
        chatBot: `${local}user/chat`, // 🆕 Added API for ChatBot
        feedbackForm: `${local}user/feedback/form`,
        contactUs: `${local}user/contactus`, // 🆕 Added API for Contact Us
        contactUS
    };
